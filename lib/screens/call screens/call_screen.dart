...
//triggered by the first user to join the channel, ie the caller
...
//triggered when any user joins the channel after the host joins it
...
//triggered when a user leaves and joins the same channel
...
//triggered when the first frome of the video call is drawn
